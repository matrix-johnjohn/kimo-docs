...
permalink: /articles/back/spring/17nacos
categories:
  - 后端
tags:
  - springcloud
...
`nacos`配置文件`custom.env`的基础语法

````env
PREFER_HOST_MODE=hostname
MODE=standalone
SPRING_DATASOURCE_PLATFORM=mysql
MYSQL_SERVICE_HOST=192.168.232.129
...
在`application.yml`中的cloud配置中添加配置;
...
void contextLoads() {
    ...
    System.out.println(service.getUri()+"/user/list");
}
````

如果你也想强奸我,那你可以随时在梦中意淫;
